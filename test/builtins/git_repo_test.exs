defmodule GitRepoTest do
  ...
  describe "git repo graph adapter" do
    setup do
      ...
      temp_dir = System.tmp_dir!() |> Path.join("git_repo_test_#{:rand.uniform(1_000_000)}")
      ...
      System.cmd("git", ["commit", "-m", "Add file1.txt"],
        cd: temp_dir,
        stderr_to_stdout: true,
        into: ""
      )
      ...
      System.cmd("git", ["commit", "-m", "Update README"],
        cd: temp_dir,
        stderr_to_stdout: true,
        into: ""
      )
      ...
      # Create a new branch
      System.cmd("git", ["checkout", "-b", "feature-branch"],
        cd: temp_dir,
        stderr_to_stdout: true,
        into: ""
      )
      ...
      System.cmd("git", ["commit", "-m", "Add feature file"],
        cd: temp_dir,
        stderr_to_stdout: true,
        into: ""
      )
      ...
      System.cmd("git", ["commit", "-m", "Modify file1 on feature branch"],
        cd: temp_dir,
        stderr_to_stdout: true,
        into: ""
      )
      ...
      System.cmd("git", ["commit", "-m", "Add main-only file"],
        cd: temp_dir,
        stderr_to_stdout: true,
        into: ""
      )
      ...
      System.cmd("git", ["merge", "feature-branch"],
        cd: temp_dir,
        stderr_to_stdout: true,
        into: ""
      )
    ...
    test "checks out initial commit and verifies file state", %{repo_path: repo_path} do
      ...
      {output, 0} =
        System.cmd("git", ["log", "--oneline", "--grep=Initial commit"], cd: repo_path)
